...
<html lang="en">
  <head>
    ...
    <link rel="icon" href="img/Logo sushi_tei.jpg" />
    <link
      rel="stylesheet"
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-sm bg-body-tertiary sticky-top">
      <div class="container">
        <a class="navbar-brand" href="#">SUSHI TEI</a>
        <button
    ...
    <section id="hero" class="text-center p-5 bg-success-subtle text-sm-start">
      <div class="container">
        <div class="d-sm-flex flex-sm-row-reverse align-items-center">
          <img src="img/Hero.jpeg" class="img-fluid" width="300" />
          <div>
            <h1 class="fw-bold display-4">
              Bringing the renowned Japanese taste to Indonesia
            </h1>
            <h4 class="lead display-6">
              Misi kami Menghasilkan masakan Jepang yang berkualitas dan layanan yang sangat baik
            </h4>
            <h6>
...
<!-- article end -->
    ...
    <!-- schedule end -->
    <!-- about me begin -->
    <section id="aboutme" class="text-center p-5 bg-success-subtle">
      <div class="container">
        <div class="d-sm-flex align-items-center justify-content-center">
          ...
          <div class="p-md-5 text-sm-start">
            <h3 class="lead">A11.2023.15152</h3>
            <h1 class="fw-bold">Ahmad Andrian Fitzal Rahman</h1>
    ...
    <script type="text/javascript">
      document.getElementById("dark").onclick = function () {
        ...
        document
          .getElementById("hero")
          .classList.remove("bg-success-subtle", "text-black");
        document
          .getElementById("hero")
      ...
      document.getElementById("light").onclick = function () {
        ...
        document
          .getElementById("hero")
          .classList.add("bg-success-subtle", "text-black");
